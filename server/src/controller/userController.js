...
exports.getAllUserData = async(req, res)=>{
    try{
        const getdata = await userModel.find().sort({_id:-1});              // find 1 -> it will get 1 data only
        //const getdata = await userModel.findOne({_id:"6673d68f3253b72e5b3d01a"})        // this is find by id
        //const getdata = await userModel.findById({_id:"6673d68f3253b72e5b3d01a"})
